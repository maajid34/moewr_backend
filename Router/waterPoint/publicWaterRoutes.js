...
const labels = {
  ...
  NOT_CHLORINATED: "Not Chlorinated",
...
| IMPORTANT:
|
| This endpoint exposes ONLY explicitly
| approved public-safe assessment information.
|
| NEVER PUBLIC:
|
| - createdBy
...
router.get(
  ...
  async (_req, res) => {
    try {
      ...
      |--------------------------------------------------------------------------
      |
      | Only assessments connected to an active
      | Water Source are allowed to become public.
      |
      */
      ...
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | PUBLIC-SAFE ASSESSMENT PROJECTION
      |--------------------------------------------------------------------------
      |
      | IMPORTANT:
      |
      | We deliberately DO NOT request private
      | fields from MongoDB.
      |
      */
        ...
        await WaterPointAssessment.find(
          ...
          .select(
            [
               ...
               *
               * Detailed internal action notes
               * remain private.
               */
              "actionPriority",
              "actionStatus",
      ...
      |--------------------------------------------------------------------------
      |
      | These preserve the behavior expected by
      | the existing PublicWaterAssessments page.
      |
      */
      ...
      for (
         ...
         *
         * This is ALL historical assessments,
      ...
      /*
      |--------------------------------------------------------------------------
      | LATEST ASSESSMENT PER WATER SOURCE
      |--------------------------------------------------------------------------
      |
      | assessments[] is sorted:
      |
      | assessmentDate DESC
      | _id DESC
      |
      | Therefore the FIRST record encountered
      | for each source is its current/latest
      | assessment.
      |
      */
      ...
      | IMPORTANT:
      |
      | One Water Source is counted ONCE.
      |
      */

      const currentRiskCategories =
        {
          LOW: 0,
      ...
      /*
      |--------------------------------------------------------------------------
      | CURRENT OPERATIONAL STATUS COUNTS
      |--------------------------------------------------------------------------
      */

      const currentOperationalStatuses =
        {
          FUNCTIONAL: 0,
      ...
      /*
      |--------------------------------------------------------------------------
      | CURRENT FLOOD EXPOSURE COUNTS
      |--------------------------------------------------------------------------
      */

      const currentFloodExposureCounts =
        {};

      /*
      |--------------------------------------------------------------------------
      | CURRENT ACTION PRIORITY COUNTS
      |--------------------------------------------------------------------------
      */

      const currentActionPriorities =
        {};

      /*
      |--------------------------------------------------------------------------
      | CURRENT ACTION STATUS COUNTS
      |--------------------------------------------------------------------------
      */
      ...
      |--------------------------------------------------------------------------
      |
      | A source is counted only once regardless
      | of assessment history length.
      |
      */
      ...
      */
      ...
      |
      | Keep the 12 most recent historical
      | assessment records.
      |
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | CURRENT SOURCE ASSESSMENTS
      |--------------------------------------------------------------------------
      |
      | This gives the frontend one current/latest
      | risk record per Water Source.
      |
      */
      ...
      return res
        ...
        .json({
          ...
          */
          ...
          summary: {
            /*
             * All historical Assessment records.
             */
            totalAssessments:
              assessments.length,

            /*
             * Unique Water Sources that have
            ...
            /*
             * Number of CURRENT/latest assessments.
             *
             * Normally equal to sourcesAssessed.
             */
            currentAssessments:
              latestAssessments.length,

            /*
             * Legacy all-history value.
             */
            maintenanceRequired,
            ...
            /*
             * Current/latest risk indicators.
             */
            criticalRiskSources:
              currentRiskCategories.CRITICAL,

            highRiskSources:
              currentRiskCategories.HIGH,

            moderateRiskSources:
              currentRiskCategories.MODERATE,

            lowRiskSources:
              currentRiskCategories.LOW,
          },

          /*
          |--------------------------------------------------------------------------
          | LEGACY ALL-HISTORY COUNTS
          |--------------------------------------------------------------------------
          |
          ...
          */
          ...
          /*
          |--------------------------------------------------------------------------
          | NEW CURRENT WATER SOURCE VIEW
          |--------------------------------------------------------------------------
          |
          | One latest Assessment per Water Source.
          |
          */
